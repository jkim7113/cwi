...
sentence = word_tokenize("Sustainability is a big issue in the contemporary world")
print(recursive_simplification(sentence))
#output: ['Sustainability', 'is', 'a', 'big', 'issue', 'in', 'the', 'modern', 'world']

sentence = word_tokenize("Motorists are being urged to take extra care in treacherous conditions.")
print(recursive_simplification(sentence))
